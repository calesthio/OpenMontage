...
│   ├── audio/              # TTS (ElevenLabs, OpenAI, Piper, Kokoro), music gen, mixing, enhancement
...
**Audio (9):** elevenlabs_tts, google_tts, openai_tts, piper_tts, kokoro_tts, tts_selector, music_gen, audio_mixer, audio_enhance
