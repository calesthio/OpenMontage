...
**This file** teaches how Balamonis Studio uses Remotion — which compositions map to pipeline
...
| Balamonis Studio Artifact | Remotion Prop | Maps To |
|---------------------|---------------|---------|
...
| Balamonis Studio Profile | Remotion Config |
|--------------------|-----------------|
