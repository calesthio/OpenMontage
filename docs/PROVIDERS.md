...
### Google — TTS + Imagen + Music (Shared Key)

> **One key, three tools.** Google Cloud TTS has 700+ voices in 50+ languages — the strongest localization option. Imagen 4 generates high-quality images. Google Lyria generates high-quality background music.

**Tools unlocked:** `google_tts`, `google_imagen`, `google_music`
...
**For Imagen and Lyria Music**, enable the Generative Language API:
...
**New account bonus:** Google Cloud offers **$300 in free credits** for new accounts (90-day trial), applicable to TTS, Imagen, and Music.
...
| **Google** | `GOOGLE_API_KEY` | `google_tts`, `google_imagen`, `google_music`, `veo_video` | Free tier + paid |
