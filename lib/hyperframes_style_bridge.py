"""Bridge Balamonis Studio playbooks → HyperFrames-friendly style artifacts.

Balamonis Studio playbooks are YAML files describing visual_language, typography,
...
def _render_design_md(
    ...
    lines = [
        title,
        "",
        f"> Generated by Balamonis Studio HyperFrames style bridge (source: {source_note}).",
        "",
        "## Colors",
        "",
