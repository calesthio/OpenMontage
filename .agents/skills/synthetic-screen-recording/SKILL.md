...
install_steps = [
    ...
    {"kind": "out", "text": "Cloning into 'Balamonis Studio'..."},
...
cuts.append({
    "id": "install-terminal",
    "type": "terminal_scene",
    "terminalTitle": "bash — Balamonis Studio setup",
    "prompt": "$",
    "accentColor": "#22D3EE",
    "steps": install_steps,
    "in_seconds": 50.0,
